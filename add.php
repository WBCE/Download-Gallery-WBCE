...
if(!$admin->get_permission('pages'))
{
    ...
    $query = "INSERT INTO `".TABLE_PREFIX."mod_download_gallery_settings` "
           . "(`section_id`,`page_id`,`header`,`files_loop`,`footer`,`file_header`,`file_footer`,`gloop`,`search_layout`,`gheader`,`gfooter`,`search_filter`) "
